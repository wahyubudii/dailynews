              ...
              <form action="{{route('update-category')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <input name="name" value="{{ $categories->name }}" type="text" class="form-control" placeholder="Ekonomi" />
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    <span class="input-group-text"><i class="bx bx-highlight"></i></span>
                    <input name="slug" value="{{ $categories->slug }}" type="text" class="form-control" placeholder="Ekonomi" />
                    <input name="id" type="hidden" value="{{$categories->id}}"/>
                  </div>
                </div> 
