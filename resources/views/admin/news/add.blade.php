              ...
              <form action="{{route('new-news')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <input name="judul" type="text" class="form-control" placeholder="Inflasi yang terus tinggi dari tahun ke tahun" />
                  </div>
                </div>
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <input name="penerbit" type="text" class="form-control" placeholder="Andrea Hirata" />
                  </div>
                </div> 
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge" style="height: 150px;">
                    <textarea name="description" type="text" class="form-control" placeholder="Peristiwa kecelakaan terjadi pada dini hari..."></textarea>
                  </div>
                ...
                <button type="submit" name="btn" value="Submit" class="mt-4 btn btn-primary">Send</button>
              </form>
            </div>
          </div>
        </div>
